<!--
 * @FilePath: \fx-mentougou\src\pages\model\data-overview\dialog\tabs\data-overview-define.vue
 * @Author: zhangxin
 * @Date: 2023-04-17 14:59:52
 * @LastEditors: zhangxin
 * @LastEditTime: 2023-07-24 14:07:10
 * @Description:
-->
<script setup>
...
const LEDStyle = computed(() => {
    return {
        width: `calc(100% + ${unref(source).showmsg?.length ?? 0 * 46}px)`,
